...
// Escapes HTML tags in non-math text segments so <input>, <form> etc.
// are shown as literal text rather than parsed as HTML by react-latex-next.
                    ...
                    {paper.questions.map((q, index) => {
                        ...
                        if (q.type === "MCQ") {
                            ...
                            if (typeof content.correctIndex === 'number') {
                                ...
                                correctAnswerDisplay = <Latex>{safeLatexText(content.options[content.correctIndex])}</Latex>;
                            }
                        } else if (q.type === "TF") {
                            isAutoGradable = true;
