...
/**
 * Next.js 16 Proxy — runs on every matched request before the route handler.
 * (Replaces legacy middleware convention in Next.js 16+)
 *
 * Responsibilities:
...
/**
 * Matcher configuration — only run proxy on matched routes.
